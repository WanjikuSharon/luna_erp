...
export const ROLE_GROUPS = {
  ...
  MANAGEMENT: [ROLES.ADMIN, ROLES.OPERATIONS_MANAGER],
  OPERATIONS: [ROLES.ADMIN, ROLES.OPERATIONS_MANAGER, ROLES.OPERATIONS],
  PRODUCTION: [ROLES.ADMIN, ROLES.OPERATIONS_MANAGER, ROLES.PRODUCTION_PERSONNEL, ROLES.PRODUCTION],
  SALES_TEAM: [ROLES.ADMIN, ROLES.SALES],
} as const;
